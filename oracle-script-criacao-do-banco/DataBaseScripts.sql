...
CREATE TABLE 
    ...
    (
         ...
         CONSTRAINT CARDS_PK PRIMARY KEY (CHARACTER)
    );

CREATE TABLE
    "QUADRINHOS".GAME_PLAYERS
    (
         PLAYER INTEGER NOT NULL,
         GAME INTEGER NOT NULL,
         CONSTRAINT PLAYER_FK1 FOREIGN KEY (PLAYER) REFERENCES "QUADRINHOS"."PLAYER",
         CONSTRAINT PLAYER_FK2 FOREIGN KEY (GAME) REFERENCES "QUADRINHOS"."GAME"
    );
